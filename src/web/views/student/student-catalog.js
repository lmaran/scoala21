import { PI, renderAbsenceList, renderAbsenceCreate } from "/views/student/my-module.js";
// alert(PI);
...
for (const showAbsenceBtn of showAbsenceBtns) {
    showAbsenceBtn.addEventListener("click", function(event) {
        ...
        // renderAbsenceList(data, absenceListContainer);

        const absenceCreateContainer = closestSubjectParent.querySelector(".absence-create-container"); // find the closest ancestor which matches the selectors
