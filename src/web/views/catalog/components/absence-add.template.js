...
const absenceCreateTemplate = data =>
    html`
        ...
        <div class="pb-3">
            ...
            <button class="collapse-add-absence-btn btn btn-sm btn-link" @click="${data.test}">Renunta</button>
        </div>
...
export function renderAbsenceCreate(data, container) {
